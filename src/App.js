...
import './App.css';
import './components/mstiteli.css'
import Mstitels from './components/mstiteli';
        ...
        <div className='App'>
          {
            ...
            <Mstitels imgLink= {avenger.imglink} name = {avenger.name} universe = {avenger.universe} ego = {avenger.ego} 
            job = {avenger.job} friends = {avenger.friends} power = {avenger.power} 
            other = {avenger.other}></Mstitels>)
